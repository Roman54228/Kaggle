...
def compute_pose(init_position, init_orientation_quat, kitti_pose):
    ...
    relative_4x4 = np.eye(4)
    relative_4x4[:3, :] = pose_matrix
    ...
    absolute_4x4 = init_4x4 @ relative_4x4

    abs_position = absolute_4x4[:3, 3]

    abs_orientation_quat_xyzw = R.from_matrix(absolute_4x4[:3, :3]).as_quat()
    abs_orientation_quat_wxyz = [abs_orientation_quat_xyzw[3],
                                 abs_orientation_quat_xyzw[0],
                                 abs_orientation_quat_xyzw[1],
                                 abs_orientation_quat_xyzw[2]]
    
    return {'position': list(abs_position), 'orientation': list(abs_orientation_quat_wxyz)}
